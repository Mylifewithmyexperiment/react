          ...
          <div className="row rowreverse">
              ...
              <div className="leftside">
                ...
                <div className="tab-content" id="myTabContent">
                    ...
                    <table className="table table-striped">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><b className="currency" /> <span className="price">6.75</span>/month</td>
                        </tr>
                        <tr>
                          <td><span className="ct">12 Months</span></td>
                          <td><span className="qty">1 — 499</span><span className="qty1 d-none">&lt;=499</span></td>
                          <td><b className="currency" /> <span className="price">6.55</span>/month</td>
                        </tr>
                        <tr>
                          <td><span className="ct">1 Month</span></td>
                        ...
                        <tr>
                          <td><span className="ct">12 Months</span></td>
                          <td><span className="qty">500 — 9999</span><span className="qty1 d-none">&gt;=500</span></td>
                          <td><b className="currency" /> <span className="price">6.36</span>/month</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  <div className="tab-pane fade" id="details" role="tabpanel" aria-labelledby="details-tab">
                    ...
                    <a href="javascript:void(0);" className="text-white gothamMedium show_moreless d-table ml-auto font-12"><span>Show More</span><i className="fa fa-chevron-down ml-2" /></a>
                  </div>
                  ...
                  <div className="card-deck">
                    <div className="card">
                      ...
                      <div className="card-body">
                        Let people join meetings on the go with a global dial-in number or contact each other directly. All they need is a mobile device and Teams. <a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                                      ...
                                      <tr>
                                        ...
                                        <td className="pr-0">
                                          <div className="addons billing_period">
                                            <span>
                                              <b>Monthly (Postpaid)</b><i className="fa fa-info-circle text-pink ml-2" />
                                            </span>
                                            <span className="info">
                                      ...
                                      <tr>
                                        ...
                                        <td className="pr-0">
                                          <div className="quantityGroup">
                                            ...
                                            <input className="quantityTxt quantity brand" name="quantity[]" type="text" defaultValue={1} maxLength={4} />
                                      ...
                                      <tr>
                                        ...
                                        <td className="pr-0">
                                          <div className="addons contact_term">
                                            <span>
                                              <b>12 Months</b><i className="fa fa-info-circle text-pink ml-2" />
                                            </span>
                                            <span className="info">
                                              Value Propagated from parent
                                            </span>
                                    ...
                                    <tbody><tr>
                                        <td>
                                          <div className="totalgroup">
                                            ...
                                            <h3 className="gothamMedium mb-1"><b className="currency" /></h3>
                                      ...
                                      <tr>
                                        <td>
                                          <a href="javascript:void(0);" className="btn btn-pink d-block addtocart px-3 mb-0"><i className="fa fa-shopping-cart mr-2" />ADD TO CART</a>
                                        </td>
                                      </tr>
                                    </tbody></table>
                                </div>
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Not enough space in SharePoint Online? Just add additional capacity ... <a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Protect your data and documents! With Office 365 Advanced Threat Protection (Plan 2), you can detect ... <a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        With Office 365 Advanced Threat Protection (Plan 1), you can protect your email in real-time from unkno…<a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#modal4" className="btn btn-pink withoutRadiusBorder">INCLUDE</a>
                        {/* Start Modal */}
                        <div className="modal fade" id="modal4" tabIndex={-1} role="dialog" aria-labelledby aria-hidden="true">
                          <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div className="modal-content">
                              <div className="modal-header">
                                <div className="addon-header">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Get more insight into your data and reduce your costs.<a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Simple access to your archive without VPN connections.<a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Skype for Business Online is a Microsoft-hosted instant messaging, video and web conferencing service.<a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Phone System – easy and efficient: Manage your telephone system in the cloud and avoid both the need for tr…<a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Bring people together and inspire them – with intelligent video features.<a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Office 365 data loss prevention (DLP) tools help protect content such as HIPAA-related and General Data Pr…<a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Additional storage capacity for Stream Plan 1 and Stream Plan 2 tenants. <a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
                    ...
                    <div className="card">
                      ...
                      <div className="card-body">
                        Microsoft 365 Business Voice (without calling plan) is a modern cloud-based telephony solution that integrates in…<a href="javascript:void(0);" className="link-details">Details<i className="fa fa-chevron-right ml-1" /></a>
                      </div>
                      <div className="card-footer">
            ...
            <div className="col-xl-4 col-lg-12">
              <div className="cartdetails-section right">
                ...
                <a href="/cartDetail" className="btn btn-pink d-block addtocart px-3 mt-3 mb-0"><i className="fa fa-shopping-cart mr-2" />ADD TO CART</a>
              </div>
            </div>
          </div>
        </div>
