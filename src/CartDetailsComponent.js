                                ...
                                <tbody>
                                    <tr stl-id="4241349">
                                        ...
                                        <td className="text-center">
                                            <div className="quantityGroup">
                                                ...
                                                <input className="quantityTxt quantity ct" name="quantity[]" type="text" defaultValue="55" maxLength="4"/>1234
                                    ...
                                    <tr stl-id="100772575">
                                        ...
                                        <td className="text-center">
                                            <div className="quantityGroup">
                                                <button type="button" className="round-btn sub" title="If u want less quantity">-</button>
                                                <input className="quantityTxt quantity ct" name="quantity[]" type="text" defaultValue="15" maxLength="4"/>5678
                                                <button type="button" className="round-btn add" title="If u want more quantity">+</button>
                                            </div>
                                        </td>
                                        <td className="gothamMedium text-right mobile-d-none"></td>
                                        <td className="onetime charges">
                                            <ul>
                                                <li className="price">
                                                    ...
                                                    <b className="currency"></b>
                                                    <span>1498.00</span>
                                                    <p className="cart_singleprice d-none">1498.00</p>
                                                </li>
                                                <li className="mrp text-danger">
                                                    <strong className="title"></strong>
                                                    <b className="currency"></b>
                                                    <span>1550.00</span>
                                                    <p className="cart_singleprice d-none">1550.00</p>
                                                </li>
                                                <li className="yousave text-success">
                                                    <strong className="title">You Save : </strong>
                                                    <b className="currency"></b>
                                                    <b><span>52.00</span> (3.35%)</b>
                                                    <p className="cart_singleprice d-none">52.00</p>
                                                </li>
                                            </ul>
                                        </td>
                                        <td className="text-right valign_middle">
                                            <div className="iconGroup d-flex flex-column">
                                                <i className="fa fa-trash text-danger">5678</i>
                                            </div>
                                        </td>
                                    </tr>
                                    <tr stl-id="4465825">
                                        ...
                                        <td className="text-center">
                                            <div className="quantityGroup">
                                                <button type="button" className="round-btn sub" title="If u want less quantity">-</button>
                                                <input className="quantityTxt quantity ct" name="quantity[]" type="text" defaultValue="14" maxLength="4"/>9876
                                                <button type="button" className="round-btn add" title="If u want more quantity">+</button>
                                            </div>
                                        </td>
                                        <td className="recurring charges">
                                            <ul>
                                                <li className="price">
                                                    ...
                                                    <b className="currency"></b>
                                                    <span>1759.00</span>
                                                    <p className="cart_singleprice d-none">1759.00</p>
                                                </li>
                                                <li className="mrp text-danger">
                                                    <strong className="title"></strong>
                                                    <b className="currency"></b>
                                                    <span>1850.00</span>
                                                    <p className="cart_singleprice d-none">1850.00</p>
                                                </li>
                                                <li className="yousave text-success">
                                                    <strong className="title">You Save : </strong>
                                                    <b className="currency"></b>
                                                    <b><span>91.00</span> (4.92%)</b>
                                                    <p className="cart_singleprice d-none">91.00</p>
                                                </li>
                                            </ul>
                                        </td>
                                        <td className="gothamMedium text-right mobile-d-none"></td>
                                        <td className="text-right valign_middle">
                                            <div className="iconGroup d-flex flex-column">
                                                <i className="fa fa-trash text-danger">91011</i>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-right text-black gothamMedium" id="cart_totalRecurring">
                                            <strong className="mr-2">Total Recurring Charges:</strong>
                                            <b className="currency"></b> <span className="gothamMedium">1759.00</span>
                                        </td>
                                        <td className="text-right text-black" id="cart_totalOnetime">
