...
//      const {quantity1} =  this.props.product_details.quantity;
        return (
            ...
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-md-10">
                        {/* <h3 className="text-white gothamMedium basket details mb-4">Your Shopping Basket <span className="gothamLight">[ <span id="totalCart">{this.props.product_details.quantity} </span> ]</span></h3> */}
                            ...
                            <tbody>
                                <tr stl-id="4241349">
                                    <td className="products pl-0">
                                            ...
                                            <div className="row no-gutters">
                                                ...
                                                <div className="card-body flex-column">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li className="pb-2">
                                                            <b class="mr-1">Plan:</b><strong id="planName">Opensource</strong> (<span id="gbdisk">1</span> GB-DISK, <span id="gbram">1</span> GB-RAM, <span id="gbbackup">1</span> GB-Backups, <span id="vpc">1</span> Virtual Processor Core)
                                                        </li>
                                                        <li>
                                      ...
                                      {/* quantity :{this.props.product_details.details.product_quantity}
                                      quantity1 :{this.props.product_details.quantity} */}
                                    <td className="text-center">
                                        <div className="quantityGroup">
                                            ...
                                            <input className="quantityTxt quantity ct"    type="number" value= { this.props.product_details.quantity}    />
                                    ...
                                    <td className="text-right valign_middle">
                                        ...
                                        <button class="fa fa-trash text-danger border-0 p-0 outline-none"  onClick={this.deleteProduct}  > </button>
                                            {/* <i className="fa fa-trash text-danger delete">454</i> */}
                                        </div>
                                    </td>
                                </tr>
...
export default connect(mapstatetoprop, mapdispatchtoprop) (CartnginxComponent);