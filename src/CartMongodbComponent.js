...
import MongodbCartdetailComponent from './MongodbCartdetailComponent'
...
class CartMongodbComponent extends React.Component {
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-md-10">
                            <h3 className="text-white gothamMedium basket mb-4">Your Shopping Basket <span className="gothamLight">[ <span id="totalCart">1</span> ]</span></h3>
                                ...
                                <tbody>
                                    <tr stl-id="4241349">
                                            ...
                                            <div className="card">
                                                <div className="row no-gutters">
                                                    <div className="cardimg">
                                                        <img src="./images/mongodb.png" className="card-img w-100 h-auto" alt="NGINX"/>
                                                    </div>
                                                    <div className="card-body flex-column">
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <b className="mr-1">Version:</b><span>4.2.8</span>
                                                            </li>
                                                            <li className="pb-2">
                                                                <b className="mr-1">Plan:</b>Standard (1 GB-DISK, 1 GB-RAM, 1 GB-Backups, 1 Virtual Processor Core)
                                                            </li>
                                                            <li>
                                                        ...
                                                        <div className="remaining">
                                                            <ul>
                                                                ...
                                                                <li><b>Workspace:</b> mongodb-07-29-2020</li>
                                        ...
                                        <td className="text-center">
                                            <div className="quantityGroup">
                                                ...
                                                <input className="quantityTxt quantity ct" name="quantity[]" type="text" value="41" maxlength="4" />4545
                                        ...
                                        <td className="onetime charges">
                                            <ul>
                                                <li className="price">
                                                    ...
                                                    <span>54.11</span>
                                                    <p className="singleprice d-none">54.11</p>
                                                </li>
                                                <li className="mrp text-danger d-none">
                                                    <strong className="title"></strong>
                                                    <b className="currency"></b>
                                                    <span>10.00</span>
                                                    <p className="singleprice d-none">10.00</p>
                                                </li>
                                                <li className="yousave text-success d-none">
                                        ...
                                        <td className="text-right valign_middle">
                                            <div className="iconGroup d-flex flex-column">
                                                <i className="fa fa-trash text-danger">432</i>
                                            </div>
                                        </td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td className="text-right text-black" id="totalOnetime">
                                            ...
                                            <b className="currency"></b> <span className="gothamMedium">54.11</span>
                                        </td>
                                        <td className="mobile-d-none"></td>
                                    </tr>
                                    <tr className="mobile-d-none">
                                        ...
                                        <td colspan="3" className="border-0 mobile-p-0">
                                            <table className="checkoutTotal">
                                                ...
                                                <tr className="checkoutrow">
                                                    ...
                                                    <td className="mobile-d-none"></td>
                                                    <td id="subtotal_cart" className="text-right pr-0 whitespacenowrap"><b className="currency"></b> <span className="gothamMedium">54.11</span></td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div className="form-row">
                                        ...
                                        <div className="col-md-5">
                                            ...
                                            <div className="form-row">
                                                ...
                                                <div className="col-md-12">
                                                    <a href="javascript:void(0);" className="btn btn-pink btn-makepayment" type="button">Confirmation</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
export default CartMongodbComponent;