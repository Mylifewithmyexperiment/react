...
class NginxCartdetailComponent extends React.Component {
  ...
  render() {
    console.log(this.props.product_details.name);
    return (
              ...
              <div className="col-12">
                <div className="d-flex align-items-center m-3 btn-goto">
                  ...
                  <a
                    ...
                    className="btn btn-success btn-checkout withoutRadiusBorder w-100"
                  >
                    CHECKOUT
                  </a>
                </div>
                  ...
                  <div className="card" stl-id="4241349">
                    <div className="row no-gutters">
                      <div className="cardimg">
                        <img
                          src={this.props.product_details.logo}
                          className="card-img"
                        />
                      </div>
                      <div className="card-body flex-column">
                        <h5 className="card-title w-100">
                          {this.props.product_details.name}
                        </h5>
                        <div className="quantityGroup">
                          <h6 className="gothamMedium mb-0">Qty :</h6>
                          <button
                            type="button"
                            className="round-btn sub"
                            title="If u want less quantity"
                            onClick={this.subsQuantity}
                          >
                            -
                          </button>
                          <label className="quantityTxt quantity ">
                            {this.props.product_details.quantity}
                          </label>
                          <button
                            type="button"
                            className="round-btn add"
                            title="If u want more quantity"
                        ...
                        <i
                          class="fa fa-trash text-danger border-0 p-0 outline-none"
