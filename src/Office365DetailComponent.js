...
class Office365DetailComponent extends React.Component {
    ...
    render() {
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="card-columns pt-0">
                  ...
                  <a href="#" className="card bg-microsoft365 bg-lightGray">
                    <div className="card-body">Microsoft 365</div>
                  </a>
                  <a href="#" className="card bg-window10 bg-lightGray">
                    <div className="card-body">Windows 10</div>
                  </a>
                  <a href="#" className="card bg-azure bg-lightGray">
                    <div className="card-body">Azure</div>
                  </a>
                  <a href="./office365_details" className="card bg-office365 bg-lightGray active">
                    <div className="card-body">Office 365</div>
                  </a>
                  <a href="#" className="card bg-msurface bg-lightGray">
                    <div className="card-body">Microsoft Surface</div>
                  </a>
                  <a href="#" className="card bg-microsoftteams bg-lightGray">
                    <div className="card-body">Teams</div>
                  </a>
                  <a href="#" className="card bg-ems bg-lightGray">
                    <div className="card-body">EMS</div>
                  </a>
                  <a href="#" className="card bg-ws bg-lightGray">
            ...
            <div className="row">
              ...
              <div className="col-xl-8 col-lg-12">
                ...
                <div className="btnGroups">
                  <a href="#" className="btn btn-white mb-2"><img src="./images/Office365.png" className="w-85px mr-3 mb-0" />Office 365 Business</a>
                  <a href="/office365_cartdetails" className="btn btn-white mb-2"><img src="./images/Office365.png" className="w-85px mr-3 mb-0" />Office 365 Enterprise</a>
                  <a href="#" className="btn btn-white mb-2"><img src="./images/Office365.png" className="w-85px mr-3 mb-0" />Office 365 Firstline</a>
                  <a href="#" className="btn btn-white mb-2"><img src="./images/Office365.png" className="w-85px mr-3 mb-0" />Office 365 eDiscovery</a>
                </div>
              </div>
              <div className="col-xl-4 col-lg-12">
                ...
                <a href="#" className="btn btn-pink addtocart px-3 mb-3 mr-2"><i className="mr-1 fas fa-file-download" />INFO FOR A FREE WORKSHOP</a>
                <a href="#" className="btn btn-pink addtocart mb-3 mr-2"><i className="mr-1 fas fa-file-download" />GET IN TOUCH</a>
                <h3 className="text-white gothamLight">Find out more about individual Microsoft 365 components.</h3>
              </div>
            </div>
          </div>
        </section>
        {/* End Infoblock section */}
        {/* Start Team section */}
        ...
        {/* End Infoblock 1 Section */}
        {/* Start Infoblock 2 Section */}
        ...
        {/* End Infoblock 2 Section */}
        {/* Start Infoblock 3 Section */}
        ...
        {/* End Infoblock 3 Section */}
        {/* Start Infoblock 4 Section */}
        ...
        {/* End Infoblock 4 Section */}
        {/* Start Infoblock 5 Section */}
        ...
        {/* End Infoblock 5 Section */}
        {/* Start Infoblock 6 Section */}
            ...
            <div className="row">
              ...
              <div className="col-lg-6">
                <ReactPlayer width="100%"
                    url="https://www.youtube.com/watch?v=DVl0R6lJUJ0"
                />
              </div>
              <div className="col-lg-6">
                <ReactPlayer width="100%"
                    url="https://www.youtube.com/watch?v=SAj4Ch9oPOE"
                />
              </div>
              <div className="col-lg-12">
